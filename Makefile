...
CPPFLAGS=-std=c++11 -I$(POLYCODEFOLDER)/Core/Dependencies/include -I$(POLYCODEFOLDER)/Core/Dependencies/include/AL -I$(POLYCODEFOLDER)/Core/include -I$(POLYCODEFOLDER)/Modules/include -I$(POLYCODEFOLDER)/Modules/Dependencies/include -I$(POLYCODEFOLDER)/Modules/Dependencies/include/bullet
